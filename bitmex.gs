...
function BMX_PrivateRequest(bmxrequest) {
  ...
  expires            = (new Date().getTime() + 60000).toFixed(9).toString().substring(0, 10);   
  bmxrequest.payload = bmxrequest.method+"/api"+bmxrequest.version+bmxrequest.command+expires;
  params             = {
